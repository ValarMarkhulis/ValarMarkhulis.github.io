...
#define DS1302_SCLK_PIN   31    // Arduino pin for the Serial Clock
#define DS1302_IO_PIN     29    // Arduino pin for the Data I/O
#define DS1302_CE_PIN     27    // Arduino pin for the Chip Enable
